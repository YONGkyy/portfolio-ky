<template>
  <section
    id="banner"
    data-aos="fade-up"
    class="min-h-screen flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-24 py-8 lg:py-0 relative"
  >
            ...
            >
              ...
              >
                ...
                <img
                  ...
                  alt="Profile"
                  class="w-48 h-48 sm:w-64 sm:h-64 lg:w-72 lg:h-72 object-cover rounded-full z-10"
                />
              </div>
            </Motion>
          </Motion>
